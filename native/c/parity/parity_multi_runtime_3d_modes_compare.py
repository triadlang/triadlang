"""Tolerant comparator for parity_multi_runtime_3d_modes."""
import math, subprocess, sys
from pathlib import Path

REPO = Path(__file__).resolve().parent.parent.parent.parent
NATIVE = REPO / "native" / "c" / "parity" / "parity_multi_runtime_3d_modes"
PY = REPO / "src" / "scripts" / "codegen" / "multi_runtime_3d_modes_to_text.py"
...
def main():
    ...
    if fails:
        ...
        return 1
    print(f"parity_multi_runtime_3d_modes: PASS ({passes}/{total})")
    return 0
