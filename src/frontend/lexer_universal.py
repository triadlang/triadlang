...
KEYWORDS = {'let', 'const', 'fn', 'return', 'if', 'else', 'elif', 'for', 'in', 'while', 'break', 'continue', 'type', 'class', 'super', 'import', 'from', 'as', 'true', 'false', 'none', 'and', 'or', 'not', 'try', 'catch', 'finally', 'throw', 'self', 'match', 'case', 'yield', 'async', 'await', 'with', 'reg', 'entity', 'world', 'couple', 'pair', 'ring', 'observe', 'OBSERVE', 'run', 'evolve', 'sequence', 'via', 'each_for', 'substrate', 'composed_of', 'assert', 'persistent', 'extended', 'structurally_open', 'non_trivial_memory', 'atomic', 'anti_collapsed', 'over_seeds'}
