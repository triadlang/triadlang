/*
 * parity_multi_runtime_3d_modes.c — Native fingerprint of the 3D
 * multi-runtime exercising dc_subtracted and phase_coherent modes.
 * Mirrors scripts/multi_runtime_3d_modes_to_text.py.
 */
...
int main(void) {
    ...
    triad_mr_add_segment(rt, 0.0, 0.1, NULL, 0, NULL, 0);
    ...
    e2[0] = (TriadCouplingEdge){ .src_id=idA, .dst_id=idB,
                                 ...
                                 .k_target=0.0 };
    triad_mr_add_segment(rt, 0.1, 0.25, e2, 1, NULL, 0);
    ...
    e3[1] = (TriadCouplingEdge){ .src_id=idB, .dst_id=idA,
                                 ...
                                 .k_target=0.0 };
    triad_mr_add_segment(rt, 0.25, 0.4, e3, 2, NULL, 0);
