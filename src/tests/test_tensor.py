import pytest
import numpy as np
from runtime.ml.tensor import TriadTensor, tensor, zeros, ones, randn, rand, arange, linspace, eye, exp, log, sqrt, tanh, sigmoid, relu, softmax, cross_entropy, mse_loss, cat, stack, bmm, transpose, layer_norm, no_grad, _ensure_tensor
