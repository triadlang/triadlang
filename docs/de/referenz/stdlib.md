# Stdlib — einfache Module

Import mit `import name;`. Vollständige Signaturen; nichts versteckt.
...
random.randint(1, 10)  // Int, beide Enden inklusive
...
// encode/decode sind Aliase von stringify/parse
```
...
datetime.timestamp()  // Epoch-Sekunden
datetime.year()  datetime.month()  datetime.day()

import regex;
regex.match("[0-9]+", "abc123")     // false (match = ab Start)
regex.search("[0-9]+", "abc123")    // "123"
regex.findall("[0-9]", "a1b22")     // ["1", "2", "2"]
regex.replace("[0-9]", "#", "a1b")  // "a#b"

// plot: matplotlib-Manieren (triad.plot ist dasselbe Modul)
import plot;
plot.plot([0, 1, 2], [0, 1, 4]);
plot.title("Parabel");
plot.savefig("raus.png");
import io;
io.print("x");   // print als Funktion (io.input liest stdin)
```
